...
Today, after midnight, a fire alarm in my dorimtory was triggered. It actually happens quite ofter, although I never saw a real fire since I moved in here :). The most annoying thing it that there are big speaker built in the ceil of every flat to notify about fire alarms. It is so damn loud. I had such a sweet sleep.

Anyway, I want to finally solder new Flake PCB today. I've been putting it off for so long already. Now when everything is ready I feel so bad for putting it of futher.
</DiaryRecord>
